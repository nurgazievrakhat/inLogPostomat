...
import com.example.sampleusbproject.data.local.converter.BoardConverter
...
import com.example.sampleusbproject.data.local.converter.CellConverter
...
@TypeConverters(CellListConverter::class, CellConverter::class, BoardConverter::class, BoardsModelConverter::class, BoardsListModelConverter::class, AnyTypeConverter::class)
